...
def portfolioMenu(USERNAME):
    ...
    while portfolioLoopExitFlag == 0:
        ...
        print(Fore.CYAN + Style.BRIGHT + "Portfolio Menu Options")
        print(Fore.BLUE + Style.BRIGHT + "1: Create Portfolio ")
        ...
        if userMenuOption == '1':
            ...
            if len(userPortfolioList) > 0:
                while incorrectPortfolioNameLoopExitFlag == 0:
                    print(Fore.CYAN + Style.BRIGHT +'your current portfolios are:',Fore.BLUE)
            ...
            if len(userPortfolioList_) > 0:
                while deleteLoopExitFlag == 0:
                    userPortfolioList_ = sql.getAllUserPortfolios(USERNAME)
                    print(Fore.CYAN + Style.BRIGHT +'your current portfolios are:')
                    ...
                    if portfolioName_ in formatedUserPortfolioList_:
                        ...
                        if input() == '1':
                            ...
                            print('would you like to exit? or delete another portfolio')
                            print('1: exit')
                            print('2: delete another')
                    else:
